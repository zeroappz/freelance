...
foreach ($queryRecords as $row) {
    ...
    $row5 = '<td class="text-center">
                <div class="btn-group">
                    <a href="language_file.php?file='.$file_name.'" class="btn btn-xs btn-info font-12"> <i class="ion-edit"></i> Edit '.$file_name.' file text</a>
                    <a href="#" data-url="panel/language_edit.php?id='.$id.'" data-toggle="slidePanel" class="btn btn-xs btn-success"> <i class="ion-edit"></i> Edit</a>
