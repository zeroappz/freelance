...
if(!isset($_GET['code']))
{
    ...
    if($code_count == 1){
        $country = $pieces[0];
        $in_name = get_countryName_by_code($country);
    }
    elseif($code_count == 2){
        $country = $pieces[0];
        $subadmin1 = $pieces[1];
        $statecode =  $country.".".$subadmin1;
        $in_name = get_stateName_by_id($_GET['code']). ", ". get_countryName_by_code($country);
    }
    elseif($code_count == 3){
        $country = $pieces[0];
        $subadmin1 = $pieces[1];
        ...
        $statecode =  $country.".".$subadmin1;
        $in_name = get_district_by_code($_GET['code']).", ".get_stateName_by_id($statecode). ", ".  get_countryName_by_code($country);
    }
}
?>
