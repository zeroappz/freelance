                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="col-md-2">
                                            <img src="<?php echo $config['site_url'];?>storage/profile/small_<?php echo $fetchuserpic; ?>" alt="<?php echo $fetchuser['name'];?>" style="width: 80px; border-radius: 50%">
                                        </div>
                                        <div class="col-md-10">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="sex">
                                            ...
                                            <option value="Other" <?php if($fetchuser['sex'] == "Other") { echo "selected"; }?>>Other</option>
                                        </select>
                                        <span class="help-block"></span>
                                    </div>
                                </div>
