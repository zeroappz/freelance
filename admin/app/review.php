...
if (!isset($_GET['action'])) {
    ...
    if ($count == 0) {
        ...
        foreach ($rows as $fetch) {
            ...
            $pageContent .= '
            <tr>
            <td><img src="../assets/js/plugins/starreviews/assets/img/rating-star'.$fetch['rating'].'.png"></td>
...
<!-- Admin stylesheet -->
<link href="../assets/js/plugins/starreviews/assets/css/starReviewsAdmin.css" rel="stylesheet" type="text/css"/>
...
<script src="../assets/js/plugins/starreviews/assets/js/jquery.form-validator.min.js"></script>

<!-- jQuery Barrating plugin -->
<script src="../assets/js/plugins/starreviews/assets/js/jquery.barrating.js"></script>

<!-- StarReviews Admin -->
<script src="../assets/js/plugins/starreviews/assets/js/starReviewsAdmin.js"></script>
