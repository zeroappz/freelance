<?php overall_header(__($pagetitle)); ?>
<style>
    .quickad-template{
        margin: 20px;
            ...
            <table class="default-table table-alt-row PaymentMethod-infoTable">
                ...
                <tr>
                    <td>
                        ...
                        <span class="PaymentMethod-info"><?php _esc($amount)?> <?php _esc($config['currency_code'])?></span>
                    </td>
                </tr>
                </tbody>
            </table>
            <div style="text-align: right"><a href="<?php url("TRANSACTION") ?>" class="button btn btn-primary"><?php _e("Transactions") ?></a></div>
        </div>
    </div>
</div>
<?php overall_footer(); ?>
